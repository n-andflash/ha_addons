...
| CC 01 16 `YY MM DD HH NN SS` <br /> FE `00 x15` `PT` | B0 01 01 00 30 | - | - | 스위치 디스플레이 업데이트 <br /> (날짜, 시각, 날씨) |
...
| CC 0B 04 00 01 00 00 42 | B0 0B 01 00 3A | - | - | ? |
| CC 02 01 00 4F | B0 41 01 00 70 | - | - | ? |

* `YY MM DD HH NN SS`: 현재 시각 (16진수)
* `00 x15`: 최저, 최고기온 등 포함된 것으로 보이는데 정보 없음
